...
class Test(AndroidCheck):
    ...
    @precondition(lambda self: self.device(resourceId="it.feio.android.omninotes:id/menu_attachment").exists()
                   and self.device(resourceId="it.feio.android.omninotes:id/menu_share").exists() and 
                   self.device(resourceId="it.feio.android.omninotes:id/menu_tag").exists() and
                   "#" in self.device(resourceId="it.feio.android.omninotes:id/detail_content").info["text"]
                   )
    @rule()
