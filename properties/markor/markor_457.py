...
class Test(AndroidCheck):
    ...
    def swipe_should_update_title(self):
        ...
        elif self.device(resourceId="net.gsantner.markor:id/nav_notebook").info["selected"]:
            assert  self.device(resourceId="net.gsantner.markor:id/toolbar").child(text="Markor").exists(), "Markor not exists"
