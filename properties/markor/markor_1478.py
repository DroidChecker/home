...
class Test(AndroidCheck):
    ...
    @precondition(
        ...
        self.device(resourceId="net.gsantner.markor:id/ui__filesystem_item__title").exists() and 
        int(self.device(resourceId="net.gsantner.markor:id/ui__filesystem_item__title").count) > 1 and
