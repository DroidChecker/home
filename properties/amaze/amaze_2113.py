...
class Test(AndroidCheck):
    ...
    def rule_rename(self):
        ...
        time.sleep(1)
        self.device(resourceId="com.amaze.filemanager:id/search_edit_text").set_text(new_file_name)
        time.sleep(1)
        self.device.send_action("search")
        time.sleep(1)
        assert self.device(text=new_file_name).exists(), "rename failed with new_file_name: " + new_file_name
