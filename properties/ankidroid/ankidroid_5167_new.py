...
class Test(AndroidCheck):
    ...
    # 5167
    @precondition(
        lambda self: self.device(resourceId="com.ichi2.anki:id/flashcard").exists() and
        self.device(resourceId="com.ichi2.anki:id/action_flag").exists() and
    ...
    def reschedule_should_display_another_card(self):
        ...
        time.sleep(1)
        self.device(text="Reschedule for review in x days").click()
        time.sleep(1)
