...
class Test(AndroidCheck):
    ...
    def option_on_one_filter_deck_should_work(self):
        ...
        assert self.device(text=deck_name).right(resourceId="com.ichi2.anki:id/deckpicker_new").get_text() == "1", "deck_name: " + deck_name + " count: " + self.device(text=deck_name).right(resourceId="com.ichi2.anki:id/deckpicker_new").get_text()
