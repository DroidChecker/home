...
class Test(AndroidCheck):
    ...
    @precondition(
        ...
        self.device(resourceId="com.ichi2.anki:id/CardEditorTagButton").exists() and
        len(self.device(resourceId="com.ichi2.anki:id/CardEditorTagButton").get_text())>=7
    )
    @rule()
    def filter_by_tag(self):
        tag_info = self.device(resourceId="com.ichi2.anki:id/CardEditorTagButton").get_text()
