...
class Test(AndroidCheck):
    ...
    @precondition(
        lambda self: self.device(text="Activity Diary").exists() and not 
        self.device(text="<No Activity>").exists() and 
        self.device(description="Statistics").info["selected"] and not 
